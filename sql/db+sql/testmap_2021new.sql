...
CREATE TABLE `ccc` (
  ...
  `test_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `city_government` (
  `id` int(11) NOT NULL,
  `city_government_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `clazz` (
  ...
  `clazz_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `protocol_info` (
  ...
  `protocol_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `province` (
  `id` int(11) NOT NULL,
  `province_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `sb_info` (
  ...
  `user_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `sb_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `sb_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `sb_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `sb_protocol_id` int(11) DEFAULT NULL,
...
CREATE TABLE `staffs` (
  ...
  `staff_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `student` (
  ...
  `student_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `user_info` (
  ...
  `user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `user_phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `user_password` (
  `encrypt_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `user_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `xxx` (
  ...
  `sadf` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `wrsa` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sfds` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `zzz` (
  ...
  `asd` int(255) DEFAULT NULL,
  `zxc` date DEFAULT NULL,
  `st` datetime DEFAULT NULL,
  `fgh` double(255,0) DEFAULT NULL,
